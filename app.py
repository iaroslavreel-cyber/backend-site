...
if __name__ == "__main__":
    ...
    # _______________________________________Объяснения______________
# Упрощенная схема работы Flask библеотеки:
...
#         ↓
# передаёт запрос Flask-приложению
#         ↓
# Flask смотрит, какой адрес запросили
#         ↓
# вызывает соответствующую функцию
#         ↓
# функция возвращает HTML
#         ↓
# Flask отправляет HTML браузеру
#         ↓
